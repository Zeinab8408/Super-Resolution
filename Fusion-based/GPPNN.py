### GPPNN : Deep Gradient Projection Networks for Pan-sharpening ###
### doi : 10.48550/arXiv.2103.04584 ###
### Implementation References: https://github.com/shuangxu96 ###
...
net = GPPNN(hs_channels, PAN_channels, mid_channels, n_layer).to(device)
